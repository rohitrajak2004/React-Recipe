 ...
 const navigate = useNavigate();
  return (
    <div className="p-6 bg-[#F9F9F9] sm:px-8 md:px-12 lg:px-20">
      ...
      <button 
      className="border-black border transition-transform text-black font-normal duration-200 hover:scale-105 rounded-sm px-4 py-1 hover:bg-black hover:text-white"
